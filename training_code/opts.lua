...
local function parse(arg)
    ...
    cmd:option('-loadModel_G',      'none', 'Provide full path to a previously trained G model')
    cmd:option('-loadModel_D',      'none', 'Provide full path to a previously trained D model')
    cmd:option('-input_nc',             3, 'of input image channels')    
    cmd:option('-output_nc',            68, 'of output image channels')    
    cmd:option('-cudnn',               1, 'use of CUDNN')               
    ...
    cmd:option('-LRdecay',           0.05, 'Learning rate decay')
    cmd:option('-momentum',          0, 'Momentum')
    cmd:option('-use_L1',              1, 'L1')
    ...
    cmd:option('-outputRes',         128, 'Output heatmap resolution')
    cmd:option('-scale',             0.12, 'Degree of scale augmentation')
    cmd:option('-rotate',             10, 'Degree of rotation augmentation')
