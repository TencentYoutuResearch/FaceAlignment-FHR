...
function createModel()
    ...
    --[[
    -- upsampleing from 128*128 to 1024*1024
    up_1 = ll_tmp - nnlib.SpatialFullConvolution(opt.nFeats,opt.nFeats,12,12,6,6,3,3) - nnlib.SpatialBatchNormalization(opt.nFeats) - nnlib.ReLU(true)
    --up_2 = up_1 - nnlib.SpatialFullConvolution(opt.nFeats,opt.nFeats,4,4,2,2,1,1) - nnlib.SpatialBatchNormalization(opt.nFeats) - nnlib.ReLU(true)
    --up_3 = up_1 - nnlib.SpatialFullConvolution(opt.nFeats,opt.nFeats,4,4,2,2,1,1) - nnlib.SpatialBatchNormalization(opt.nFeats) - nnlib.ReLU(true)
    up_4 = up_1 - nnlib.SpatialConvolution(opt.nFeats,ref.nOutChannels,1,1,1,1,0,0)
    table.insert(out,up_4)
    ]]--
