...
function Dataset:__init()
    ...
    local annot = {}
    Groundtruth = matio.load('/data1/yingtai/torch/landmark_chen/data/Groundtruth_public.mat', 'Groundtruth')
    Boundingbox = matio.load('/data1/yingtai/torch/landmark_chen/data/Boundingbox_public.mat', 'Boundingbox')
...
function Dataset:getPath(idx)
    return paths.concat('/data1/yingtai/torch/landmark_chen/data/public_train/',ffi.string(idx..'.jpg'))
end
